...
const next = nextAfter('/history/second-partition-1793');

/**
 * The Second Partition of 1793, from the Prussian alliance that failed to
 * the silent Sejm at Grodno and the cut army that set off the rising of
 * 1794, told as a filmstrip: scrolling down drives the frames
...
/**
 * The frame on the two shares carries the partition map instead, and its
 * backdrop, a Russian atlas map of the lands taken in 1793, is dimmed the
...
/**
 * The map and Deisch's engraving of the Gdansk crane are wide, so they get
 * the wide panel; squeezed into the narrow one they shrink to a postage stamp.
 */
const isWide = (key: string): boolean => hasMap(key) || key === 'gdansk';

/**
 * The one photographic backdrop is anchored on its subject, the castle on
 * its hill at the right of the picture.
 */
const focus: Record<string, string> = {
    today: 'object-[70%_center]',
};
...
<template>
    <Head :title="t('partition2.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('partition2.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/partition2-hero-sm.avif  960w,
                        /images/partition2-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/partition2-hero-sm.jpg"
                    srcset="
                        /images/partition2-hero-sm.jpg  960w,
                        /images/partition2-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/partition2-${frame.photo}-sm.avif 960w, /images/partition2-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/partition2-${frame.photo}-sm.jpg`"
                                :srcset="`/images/partition2-${frame.photo}-sm.jpg 960w, /images/partition2-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                <div class="max-w-[46ch]">
                                    ...
                                    <ExhibitImage
                                        ...
                                        :srcset="`/images/partition2-${frame.photo}-sm.jpg 960w, /images/partition2-${frame.photo}-lg.jpg 1280w`"
                                        sizes="90vw"
                                        :full="`/images/partition2-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
                                ...
                                >
                                    <ExhibitImage
                                        v-if="hasMap(frame.key)"
                                        src="/images/partition2-laurie-sm.jpg"
                                        srcset="/images/partition2-laurie-sm.jpg 960w, /images/partition2-laurie-lg.jpg 1600w"
                                        sizes="(min-width: 1024px) 34rem, 90vw"
                                        full="/images/partition2-laurie-lg.jpg"
                                        :alt="t('partition2.periodmap.alt')"
                                        :caption="
                                            t('partition2.periodmap.caption')
                                        "
                                        :credit="
                                            t('partition2.periodmap.credit')
                                        "
                                        with-caption
                                    />
                                    <ExhibitImage
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('partition2.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('partition2.sources.body') }}
                </p>
