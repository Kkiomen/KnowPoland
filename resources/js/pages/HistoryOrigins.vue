...
const next = nextAfter('/history/how-poland-began');

/**
 * The first article, told as a filmstrip: scrolling down drives the frames
...
const frames = computed<Frame[]>(() => group<Frame[]>('origins.frames') ?? []);
...
<template>
    <Head :title="t('origins.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('origins.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/origins-biskupin-sm.avif  760w,
                        /images/origins-biskupin-lg.avif 1200w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/origins-biskupin-sm.jpg"
                    srcset="
                        /images/origins-biskupin-sm.jpg  760w,
                        /images/origins-biskupin-lg.jpg 1200w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/origins-${frame.photo}-sm.avif 760w, /images/origins-${frame.photo}-lg.avif 1200w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/origins-${frame.photo}-sm.jpg`"
                                :srcset="`/images/origins-${frame.photo}-sm.jpg 760w, /images/origins-${frame.photo}-lg.jpg 1200w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            <div
                                ...
                                :class="
                                    frame.key === 'tribes'
                                        ...
                                        : 'block film:grid-cols-[minmax(0,46ch)_minmax(0,22rem)]'
                                "
                            >
                                ...
                                <div
                                    v-if="frame.key === 'tribes'"
                                    class="border-hairline bg-ink/60 w-full max-w-[34rem] border p-4 backdrop-blur-[2px]"
                                >
                                    <ExhibitImage
                                        src="/images/origins-tribesmap-sm.jpg"
                                        srcset="/images/origins-tribesmap-sm.jpg 960w, /images/origins-tribesmap-lg.jpg 1600w"
                                        sizes="(min-width: 1024px) 34rem, 90vw"
                                        full="/images/origins-tribesmap-lg.jpg"
                                        :alt="t('origins.map.alt')"
                                        :caption="t('origins.map.caption')"
                                        :credit="t('origins.map.credit')"
                                        with-caption
                                    />
                                </div>
                            </div>
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('origins.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('origins.sources.body') }}
                </p>
