...
const next = nextAfter('/history/jan-karski');

/**
 * Jan Karski: the deep version of the third topic in the resistance chapter of
 * the Second World War overview. Where he came from, the Soviet captivity he
 * walked out of as a private, the courier routes over the mountains, the
 * arrest in Slovakia in 1940 and the rescue that cost 32 lives, the two Jewish
 * leaders who gave him their message in 1942, the ghetto and the transit camp
 * he called Belzec and which historians identify as Izbica, London and
 * Washington, the long silence afterwards, and the benches he sits on now.
 *
 * Witold Pilecki, who reported from inside a camp, is the article before this
 * one, and the underground state, the ghettos, the death camps and the
 * government in London are articles of their own: each is introduced here in a
 * line and handed on rather than retold.
 *
...
const frames = computed<Frame[]>(() => group<Frame[]>('karski.frames') ?? []);
...
<template>
    <Head :title="t('karski.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('karski.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/karski-hero-sm.avif  960w,
                        /images/karski-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/karski-hero-sm.jpg"
                    srcset="
                        /images/karski-hero-sm.jpg  960w,
                        /images/karski-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/karski-${frame.photo}-sm.avif 960w, /images/karski-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/karski-${frame.photo}-sm.jpg`"
                                :srcset="`/images/karski-${frame.photo}-sm.jpg 960w, /images/karski-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('karski.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('karski.sources.body') }}
                </p>
