...
const next = nextAfter('/history/gniezno-the-first-capital');

/**
 * Gniezno from the first stronghold to the fire of 1945, told as a
 * filmstrip: scrolling down drives the frames sideways. On a phone the strip becomes an ordinary vertical stack, because
...
const frames = computed<Frame[]>(() => group<Frame[]>('gniezno.frames') ?? []);
 ...
 * dimmed to a texture.
 */
const exhibits = new Set(['name', 'primate', 'fire']);
...
<template>
    <Head :title="t('gniezno.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('gniezno.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/gniezno-seats-sm.avif  960w,
                        /images/gniezno-seats-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/gniezno-seats-sm.jpg"
                    srcset="
                        /images/gniezno-seats-sm.jpg  960w,
                        /images/gniezno-seats-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                    class="absolute inset-0 h-full w-full object-cover object-[center_40%] opacity-30"
                    loading="eager"
                    decoding="async"
                />
            </picture>
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/gniezno-${frame.photo}-sm.avif 960w, /images/gniezno-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/gniezno-${frame.photo}-sm.jpg`"
                                :srcset="`/images/gniezno-${frame.photo}-sm.jpg 960w, /images/gniezno-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                        ...
                        >
                            <div
                                class="grid gap-8 film:grid-cols-[minmax(0,46ch)_minmax(0,22rem)] film:items-end"
                                :class="hasPanel(frame.key) ? '' : 'block'"
                            >
                                ...
                                >
                                    <ExhibitImage
                                        ...
                                        :full="`/images/gniezno-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('gniezno.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('gniezno.sources.body') }}
                </p>
