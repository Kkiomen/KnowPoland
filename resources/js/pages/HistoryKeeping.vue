...
const next = nextAfter('/history/keeping-a-country');

/**
 * How a nation without a state kept itself going between 1795 and 1918:
 * Chopin and his heart, the poets of the emigration, the churches and the
 * synagogues, organic work in Poznan and positivism in Warsaw, the secret
 * classrooms, Galician autonomy, the school strikes in Prussia and the two
 * Nobel prizes, told as a filmstrip: scrolling down drives the frames
...
const frames = computed<Frame[]>(() => group<Frame[]>('keeping.frames') ?? []);

/*
 * Every picture on this page is a document of its time - a daguerreotype, a
 * first edition, a shop invoice, studio portraits, a school photograph, a
 * painting, a laboratory - and cropping one to fill a widescreen frame
 * destroys the very thing the reader came to see. So each is shown whole, on
 * its own plate, with the same picture behind it dimmed to a texture.
 */

/**
 * The open book, the invoice, Matejko's canvas, the class of Wrzesnia and
 * the laboratory are wide, so they get the wide panel; the four portraits
 * stand upright and fit the narrow one.
 */
const wide = new Set(['bards', 'work', 'galicia', 'prussia', 'nobel']);
...
<template>
    <Head :title="t('keeping.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('keeping.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/keeping-hero-sm.avif  960w,
                        /images/keeping-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/keeping-hero-sm.jpg"
                    srcset="
                        /images/keeping-hero-sm.jpg  960w,
                        /images/keeping-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/keeping-${frame.photo}-sm.avif 960w, /images/keeping-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/keeping-${frame.photo}-sm.jpg`"
                                :srcset="`/images/keeping-${frame.photo}-sm.jpg 960w, /images/keeping-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    <ExhibitImage
                                        ...
                                        "
                                        :full="`/images/keeping-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('keeping.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('keeping.sources.body') }}
                </p>
