...
const next = nextAfter('/history/witold-pilecki');

/**
 * Witold Pilecki: the deep version of the second topic in the resistance
 * chapter of the Second World War overview. Where he came from, the army he
 * helped found in November 1939, the decision to enter Auschwitz on forged
 * papers, the conspiracy he built there, the escape from the camp bakery,
 * what his reports said and what they got wrong, the Warsaw Uprising and the
 * return from Italy, the trial that had him shot in 1948, and what a visitor
 * can stand in front of today.
 *
 * Auschwitz as a killing site, the underground state he served and the
 * government in London are other articles, and so is Jan Karski: each is
 * introduced here in a line and handed on rather than retold.
 *
...
const frames = computed<Frame[]>(() => group<Frame[]>('pilecki.frames') ?? []);
...
<template>
    <Head :title="t('pilecki.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('pilecki.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/pilecki-hero-sm.avif  960w,
                        /images/pilecki-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/pilecki-hero-sm.jpg"
                    srcset="
                        /images/pilecki-hero-sm.jpg  960w,
                        /images/pilecki-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/pilecki-${frame.photo}-sm.avif 960w, /images/pilecki-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/pilecki-${frame.photo}-sm.jpg`"
                                :srcset="`/images/pilecki-${frame.photo}-sm.jpg 960w, /images/pilecki-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('pilecki.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('pilecki.sources.body') }}
                </p>
