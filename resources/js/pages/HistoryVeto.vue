...
const next = nextAfter('/history/liberum-veto');

/**
 * Elected kings and the liberum veto, from the election field at Wola to the
 * Russian guarantee of 1768 and the Bar Confederation, told as a filmstrip:
...
const frames = computed<Frame[]>(() => group<Frame[]>('veto.frames') ?? []);
...
/**
 * The engraving of the Sejm and the siege map are wide sheets, so they get
 * the wide panel; squeezed into the narrow one they shrink to a postage stamp.
 */
const wide = new Set(['sejm', 'double']);

const isWide = (key: string): boolean => wide.has(key);

/**
 * Backdrops wider than their frame are anchored on the subject: the
 * senators' shed in the two election paintings, the far end of the hall.
 */
const focus: Record<string, string> = {
    field: 'object-[35%_center]',
    poniatowski: 'object-[55%_center]',
};
...
<template>
    <Head :title="t('veto.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('veto.meta.description')"
        />
    </Head>
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/veto-hero-sm.avif  960w,
                        /images/veto-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/veto-hero-sm.jpg"
                    srcset="
                        /images/veto-hero-sm.jpg  960w,
                        /images/veto-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/veto-${frame.photo}-sm.avif 960w, /images/veto-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/veto-${frame.photo}-sm.jpg`"
                                :srcset="`/images/veto-${frame.photo}-sm.jpg 960w, /images/veto-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    <ExhibitImage
                                        ...
                                        "
                                        :full="`/images/veto-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
