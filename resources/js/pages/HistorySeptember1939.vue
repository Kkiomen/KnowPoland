...
const next = nextAfter('/history/september-1939');

/**
 * The five weeks that opened the Second World War in Poland: the German
 * demands over Danzig, the pact Germany and the Soviet Union signed in August
 * and the secret protocol that divided the country, what each army actually
 * had, the first morning at Wielun and Westerplatte, the border battles and
 * the Bzura, the siege of Warsaw, the Soviet invasion of 17 September, the
 * last fights at Hel and Kock, what the campaign cost, and where a visitor can
 * stand in it today. Told as a filmstrip: scrolling down drives the frames
...
const frames = computed<Frame[]>(() => group<Frame[]>('sept1939.frames') ?? []);

/**
 * One frame carries a document rather than a scene: the photograph of the
 * Moscow signing, which is an upright plate and loses its faces when it is
 * cropped to fill a widescreen frame. It gets its own plate, with the same
 * picture behind it dimmed to a texture.
 */
const exhibits = new Set(['road']);

const isExhibit = (key: string): boolean => exhibits.has(key);

/**
 * The frame on the two occupation zones carries the demarcation map the two
 * foreign ministers signed in Moscow, which opens full screen like any other
 * exhibit, because nobody can read a map at panel size.
 */
...
/**
 * Both panels here are upright sheets - a studio photograph printed tall and a
 * map drawn tall - so both sit in the narrow panel, where they are not
...
<template>
    <Head :title="t('sept1939.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('sept1939.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/sept1939-hero-sm.avif  960w,
                        /images/sept1939-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/sept1939-hero-sm.jpg"
                    srcset="
                        /images/sept1939-hero-sm.jpg  960w,
                        /images/sept1939-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/sept1939-${frame.photo}-sm.avif 960w, /images/sept1939-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/sept1939-${frame.photo}-sm.jpg`"
                                :srcset="`/images/sept1939-${frame.photo}-sm.jpg 960w, /images/sept1939-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    <ExhibitImage
                                        ...
                                        src="/images/sept1939-map-sm.jpg"
                                        srcset="/images/sept1939-map-sm.jpg 960w, /images/sept1939-map-lg.jpg 1280w"
                                        sizes="(min-width: 1024px) 22rem, 90vw"
                                        full="/images/sept1939-map-lg.jpg"
                                        with-caption
                                        :alt="t('sept1939.map.alt')"
                                        :caption="t('sept1939.map.caption')"
                                        :credit="t('sept1939.map.credit')"
                                    />
                                    <ExhibitImage
                                        v-else
                                        :src="`/images/sept1939-${frame.photo}-sm.jpg`"
                                        :srcset="`/images/sept1939-${frame.photo}-sm.jpg 960w, /images/sept1939-${frame.photo}-lg.jpg 1280w`"
                                        sizes="(min-width: 1024px) 22rem, 90vw"
                                        :full="`/images/sept1939-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('sept1939.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('sept1939.sources.body') }}
                </p>
