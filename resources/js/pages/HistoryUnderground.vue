...
const next = nextAfter('/history/underground-state');

/**
 * The Polish Underground State: the deep version of the first topic in the
 * resistance chapter of the Second World War overview. What an underground
 * state was, how the armed underground grew from 1939 into the Home Army, the
 * Government Delegate's Office and its courts, the secret schools and the
 * secret press, how London paid for it, the intelligence it sent out, the
 * politics inside it, how it ended, and where a visitor meets it today.
 *
 * The government in London, the occupation administration, the ghettos and
 * the killing centres are other articles, and so are Witold Pilecki, Jan
 * Karski, Enigma and the Warsaw Uprising of 1944: each is introduced here in
 * a line and handed on rather than retold.
 *
...
const frames = computed<Frame[]>(
    () => group<Frame[]>('underground.frames') ?? [],
);

/**
 * One frame carries a symbol rather than a scene: the kotwica, the anchor of
 * Fighting Poland, which a visitor meets on walls all over Warsaw. It opens
 * full screen, because the two letters inside the shape are the whole point
 * and they are not legible at panel size.
 */
const hasAnchor = (key: string): boolean => key === 'today';

/** A frame has a side panel when it holds that picture. */
const hasPanel = (key: string): boolean => hasAnchor(key);
...
<template>
    <Head :title="t('underground.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('underground.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/underground-hero-sm.avif  960w,
                        /images/underground-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/underground-hero-sm.jpg"
                    srcset="
                        /images/underground-hero-sm.jpg  960w,
                        /images/underground-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/underground-${frame.photo}-sm.avif 960w, /images/underground-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/underground-${frame.photo}-sm.jpg`"
                                :srcset="`/images/underground-${frame.photo}-sm.jpg 960w, /images/underground-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <ExhibitImage
                                        src="/images/underground-anchor-sm.jpg"
                                        srcset="/images/underground-anchor-sm.jpg 960w, /images/underground-anchor-lg.jpg 1280w"
                                        sizes="(min-width: 1024px) 22rem, 90vw"
                                        full="/images/underground-anchor-lg.jpg"
                                        with-caption
                                        :alt="t('underground.anchor.alt')"
                                        :caption="
                                            t('underground.anchor.caption')
                                        "
                                        :credit="t('underground.anchor.credit')"
                                    />
                                </div>
                            </div>
                        </div>
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('underground.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('underground.sources.body') }}
                </p>
