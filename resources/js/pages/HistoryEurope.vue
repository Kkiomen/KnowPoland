...
const next = nextAfter('/history/nato-and-the-eu');

/**
 * How Poland got into NATO in 1999 and the European Union in 2004, and what the
 * two dates bought: the security vacuum the Soviet withdrawal left behind, the
 * Partnership for Peace, the Madrid invitation, the accession ceremony in
 * Independence, Missouri, the end of conscription, the Copenhagen criteria and
 * the law that had to be rewritten to meet them, the two-day referendum of June
 * 2003, the open labour markets and the emigration that followed, the money and
 * the roads it built, Schengen, and the rule-of-law row with Brussels. Told as a
 ...
 * screen is a good way to lose the reader. Every frame carries a photograph as
 * its backdrop and nothing that needs reading close up, so there are no exhibit
 * panels here.
 */
type Frame = {
    key: string;
...
const frames = computed<Frame[]>(() => group<Frame[]>('euro.frames') ?? []);
...
<template>
    <Head :title="t('euro.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('euro.meta.description')"
        />
    </Head>
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/euro-hero-sm.avif  960w,
                        /images/euro-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/euro-hero-sm.jpg"
                    srcset="
                        /images/euro-hero-sm.jpg  960w,
                        /images/euro-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/euro-${frame.photo}-sm.avif 960w, /images/euro-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/euro-${frame.photo}-sm.jpg`"
                                :srcset="`/images/euro-${frame.photo}-sm.jpg 960w, /images/euro-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                        ...
                        >
                            <div class="grid gap-8 film:items-end">
