...
const next = nextAfter('/history/katyn');

/**
 * Katyn and the deportations east, 1939 to today: the deep version of the third
 * topic in the occupation chapter of the Second World War overview. The Soviet
 * zone and the arrests, the three camps and the letters that stopped, the
 * decision of March 1940 and where the shootings happened, the four deportation
 * waves and life in exile, the discovery of 1943 and the break with Moscow,
 * fifty years of official denial, the admissions after 1990, and where the
 * story is kept today.
 *
 * The government in exile article carries the diplomatic break of 1943 and the
 * army that left the Soviet Union, and they are only bridged to here.
 *
...
const frames = computed<Frame[]>(() => group<Frame[]>('katyn.frames') ?? []);

/**
 * Two frames carry a paper document rather than a scene: the postcard returned
 * to a prisoner's family in June 1940 and the first page of the note Lavrentiy
 * Beria sent to Stalin. Both have to be read rather than glanced at, so both
 * get their own plate, with the same picture behind them dimmed to a texture.
 *
 * No map is published on this page. See the sources note for why.
 */
const exhibits = new Set(['camps', 'decision']);
...
/** Both panels here are paper, so they sit in the narrow column. */
...
<template>
    <Head :title="t('katyn.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('katyn.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/katyn-hero-sm.avif  960w,
                        /images/katyn-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/katyn-hero-sm.jpg"
                    srcset="
                        /images/katyn-hero-sm.jpg  960w,
                        /images/katyn-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/katyn-${frame.photo}-sm.avif 960w, /images/katyn-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/katyn-${frame.photo}-sm.jpg`"
                                :srcset="`/images/katyn-${frame.photo}-sm.jpg 960w, /images/katyn-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    <ExhibitImage
                                        ...
                                        :full="`/images/katyn-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('katyn.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('katyn.sources.body') }}
                </p>
