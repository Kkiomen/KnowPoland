...
import GoldenMap from '@/components/GoldenMap.vue';
import { nextAfter } from '@/history-articles';
import { group, t } from '@/i18n';

const next = nextAfter('/history/the-golden-age');

/**
 * The golden age of the 16th century, from a king bound by his nobles to the
 * grain boats on the Vistula and the last Jagiellon, told as a filmstrip: scrolling down drives the frames sideways. On a phone the strip becomes an ordinary vertical stack, because
...
const frames = computed<Frame[]>(() => group<Frame[]>('golden.frames') ?? []);
...
/**
 * The frame on the grain trade carries the map of the river instead, and its
 * backdrop, the harbour crane in Gdansk, is dimmed the same way an exhibit's is.
 */
const hasMap = (key: string): boolean => key === 'grain';
...
<template>
    <Head :title="t('golden.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('golden.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/golden-hero-sm.avif  960w,
                        /images/golden-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/golden-hero-sm.jpg"
                    srcset="
                        /images/golden-hero-sm.jpg  960w,
                        /images/golden-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/golden-${frame.photo}-sm.avif 960w, /images/golden-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/golden-${frame.photo}-sm.jpg`"
                                :srcset="`/images/golden-${frame.photo}-sm.jpg 960w, /images/golden-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ExhibitImage
                                        ...
                                        :full="`/images/golden-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('golden.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('golden.sources.body') }}
                </p>
