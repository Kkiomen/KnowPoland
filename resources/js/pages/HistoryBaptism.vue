...
import BaptismMap from '@/components/BaptismMap.vue';
import { nextAfter } from '@/history-articles';
import { group, t } from '@/i18n';

const next = nextAfter('/history/baptism-of-966');

/**
 * The baptism of 966, from the pagan duke to the holiday voted in 2019,
...
const frames = computed<Frame[]>(() => group<Frame[]>('baptism.frames') ?? []);
 ...
 * dimmed to a texture.
 */
const exhibits = new Set(['pagan', 'squeeze', 'dobrawa', 'baptism']);

const isExhibit = (key: string): boolean => exhibits.has(key);

/**
 * The frame on Mieszko's motives carries the map instead, and its backdrop, a
 * manuscript page, is dimmed to a texture the same way an exhibit's is.
 */
...
<template>
    <Head :title="t('baptism.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('baptism.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/baptism-tumski-sm.avif  960w,
                        /images/baptism-tumski-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/baptism-tumski-sm.jpg"
                    srcset="
                        /images/baptism-tumski-sm.jpg  960w,
                        /images/baptism-tumski-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/baptism-${frame.photo}-sm.avif 960w, /images/baptism-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/baptism-${frame.photo}-sm.jpg`"
                                :srcset="`/images/baptism-${frame.photo}-sm.jpg 960w, /images/baptism-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
                            ...
                            >
                                ...
                                >
                                    ...
                                    <ExhibitImage
                                        ...
                                        :full="`/images/baptism-${frame.photo}-lg.jpg`"
                                        :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('baptism.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('baptism.sources.body') }}
                </p>
