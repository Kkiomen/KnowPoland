...
const next = nextAfter('/history/enigma');

/**
 * Enigma: the deep version of the fourth topic in the resistance chapter of the
 * Second World War overview. What the machine was and why it was thought
 * unbreakable, why the Polish Cipher Bureau went looking for mathematicians
 * rather than linguists, the 1929 course in Poznan, Marian Rejewski's
 * reconstruction of the wiring in December 1932, the cyclometer, the card
 * catalogue, Zygalski's sheets and the bomba, the German changes of December
 * 1938 that outran Polish money, the handover at Pyry on 25 July 1939, what
 * Bletchley Park built on top of it, and the forty years it took for the credit
 * to arrive.
 *
 * The Second Republic, the underground state, Jan Karski and the government in
 * London are articles of their own: each is introduced here in a line and
 * handed on rather than retold. Bletchley Park gets its own weight here, the
 * Turing-Welchman bombe and naval Enigma included, because a page that only
 * counted the Polish side would be making the same mistake in reverse.
 *
...
const frames = computed<Frame[]>(() => group<Frame[]>('enigma.frames') ?? []);
...
<template>
    <Head :title="t('enigma.meta.title')">
        <meta
            head-key="description"
            name="description"
            :content="t('enigma.meta.description')"
        />
    </Head>
    ...
    <main class="bg-ink">
        ...
        <section class="relative overflow-hidden">
            <picture>
                <source
                    type="image/avif"
                    srcset="
                        /images/enigma-hero-sm.avif  960w,
                        /images/enigma-hero-lg.avif 1280w
                    "
                    sizes="100vw"
                />
                <img
                    src="/images/enigma-hero-sm.jpg"
                    srcset="
                        /images/enigma-hero-sm.jpg  960w,
                        /images/enigma-hero-lg.jpg 1280w
                    "
                    sizes="100vw"
                    alt=""
                ...
                >
                    ...
                    >
                        <picture>
                            <source
                                type="image/avif"
                                :srcset="`/images/enigma-${frame.photo}-sm.avif 960w, /images/enigma-${frame.photo}-lg.avif 1280w`"
                                sizes="100vw"
                            />
                            <img
                                :src="`/images/enigma-${frame.photo}-sm.jpg`"
                                :srcset="`/images/enigma-${frame.photo}-sm.jpg 960w, /images/enigma-${frame.photo}-lg.jpg 1280w`"
                                sizes="100vw"
                                :alt="frame.caption"
        ...
        <section class="border-hairline border-t">
            <div class="mx-auto w-full max-w-[1200px] px-6 py-14 sm:py-16">
                ...
                >
                    {{ t('enigma.sources.label') }}
                </p>
                <p class="text-bone-muted mt-3 max-w-[70ch]">
                    {{ t('enigma.sources.body') }}
                </p>
